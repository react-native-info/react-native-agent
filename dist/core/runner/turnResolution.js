...
import { RunMessageOutputItem, RunToolApprovalItem } from '../items';
import { getRefusalFromOutputMessage, getTextFromOutputMessage, } from '../utils/messages';
import { getSchemaAndParserFromInputType } from '../utils/tools';
import { safeExecute } from '../utils/safeExecute';
import { addErrorToCurrentSpan } from '../tracing/context';
import { SingleStepResult, nextStepSchema } from './steps';
import { checkForFinalOutputFromTools, executeApplyPatchOperations, executeComputerActions, executeFunctionToolCalls, executeHandoffCalls, executeShellActions, collectInterruptions, } from './toolExecution';
import { handleHostedMcpApprovals } from './mcpApprovals';
import { getFunctionToolQualifiedName } from '../toolIdentity';
import { createRunErrorFinalOutputItem, formatRunErrorFinalOutput, resolveRunErrorHandler, } from './errorHandlers';
 ...
 */
export async function resolveTurnAfterModelResponse(agent, originalInput, originalPreStepItems, newResponse, processedResponse, runner, state, toolErrorFormatter, errorHandlers) {
