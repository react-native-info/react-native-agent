...
declare const modelResponseSchema: z.ZodObject<{
    ...
    output: z.ZodArray<z.ZodDiscriminatedUnion<[z.ZodObject<{
        ...
        output: z.ZodUnion<readonly [z.ZodString, z.ZodDiscriminatedUnion<[z.ZodObject<{
            ...
            detail: z.ZodOptional<z.ZodType<"auto" | "high" | "low" | (string & {}), unknown, z.core.$ZodTypeInternals<"auto" | "high" | "low" | (string & {}), unknown>>>;
        }, z.core.$strip>, z.ZodObject<{
            providerData: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodAny>>;
...
declare const itemSchema: z.ZodDiscriminatedUnion<[z.ZodObject<{
 ...
 * @internal
 */
export declare function buildAgentMap(initialAgent: Agent<any, any>): Map<string, Agent<any, any>>;
/**
 * @internal
 */
export declare function deserializeSpan(trace: Trace, serializedSpan: SerializedSpanType): Span<any>;
/**
 * @internal
 */
export declare function deserializeModelResponse(serializedModelResponse: z.infer<typeof modelResponseSchema>): ModelResponse;
/**
 * @internal
 */
export declare function deserializeItem(serializedItem: z.infer<typeof itemSchema>, agentMap: Map<string, Agent<any, any>>): RunItem;
export {};
